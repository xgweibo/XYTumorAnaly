...
workflowIndexModule.controller('WFComponentUpdateCtrl',
        function ($location, $log, $routeParams, WFComponentWS, $scope
        //, CMPNTPARAMCOLUMNS1,
...
//get data from server 
            WFComponentUpdateCtrl.WFComponent = WFComponentWS.get({id: $routeParams.id},
                    ...
                    function () {
                        ...
                        */
                        WFComponentUpdateCtrl.updateWFComponent = function () {
                            ...
                            WFComponentUpdateCtrl.WFComponent.$update({id: WFComponentUpdateCtrl.WFComponent.id},
                                    function () {
